...
import com.example.fyp.databinding.ActivityVerifyPasswordBinding

class Verify_Password : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.sendButton.setOnClickListener {
            // After clicking "Send", navigate to New Password screen
